...
import static Jogo.SalasJogo.CharacterScreen.titleScreen;
...
public class Sala1_Taberna1 {
    ...
    public static void sala1_Inicio(Herois heroi) throws InterruptedException, FileNotFoundException {
        ...
        sleep(900);
        System.out.println("\n\n");
        System.out.println("Numa terra distante, onde existem ogres e dragões," + heroi.getNome() + " passa por tempos dificeis...");
        System.out.println("Toda a sua famila morreu num incendio, no qual ele perdeu também todas as suas posses.");
        System.out.println("Pobre, triste, sozinho e quase sem dinheiro ( já disse pobre? ), " + heroi.getNome()+ " tenta procurar trabalho na Taberna local...");
        ...
        switch (opcao){
            ...
            case 1:
                sleep(700);
                System.out.println("\n " + heroi.getNome() + " dirige-se até ao JobBoard e encontra apenas um panfleto...");
                ...
                sleep(700);
                System.out.println("\nO Taberneiro dirige-se a " + heroi.getNome() + " e diz:");
            ...
            case 2:
                ...
                System.out.println("Irritado ele mata " + heroi.getNome() + "...");
