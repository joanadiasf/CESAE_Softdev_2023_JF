...
public class Sala8_Masmorras {
     ...
     * Escolha SALA DO REI
     */
    public static void salaRei(Herois heroi) throws FileNotFoundException, InterruptedException {
     ...
     * Escolha MASMORRAS
     */
    public static void masmorras(Herois heroi) throws FileNotFoundException, InterruptedException {
        ...
        //batalha final *****************
        System.out.println("Tobias O Grande appears!!");
