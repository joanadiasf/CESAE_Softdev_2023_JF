...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        gameStore.addGameTOStock(new VideoGame("Legend of Zelda: Breath of the Wild","Nintendo",30.0,60.0));
        ...
        gameStore.addGameTOStock(new VideoGame("Assassin's Credd Valhalla","Ubisoft",35.0,55.0));
        ...
        gameStore.addGameTOStock(new VideoGame("Call of Duty: Modern Warface","Activision",30.0,50.0));
        gameStore.addGameTOStock(new VideoGame("Super Mario Odyssey","Nintendo",40.0,60.0));
        gameStore.addGameTOStock(new VideoGame("The Last of Us II","Naughty Dog",30.0,60.0));
